...
path = r"D:\Users\andre.WIN-UT7BSJO8U2I\Temp\DP_-_Colaboradores_-_Listagem_detalhada_de_eventos_e_notificações.xls"
if not os.path.exists(path):
    print("Could not find exact path, finding latest xls...")
    files = glob.glob(r"D:\Users\andre.WIN-UT7BSJO8U2I\Temp\*.xls")
