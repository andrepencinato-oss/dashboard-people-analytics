          ...
          Object.keys(roleGroups).sort().forEach(cargo => {
              ...
              colabs.forEach(e => {
                  ...
                  colabsHtml += `<div class="colab-item">
                      ...
                      <div class="colab-stat-col" title="Faltas">Faltas:<br><span style="font-size:14px;color:var(--ink);">${stats.faltas}</span></div>
                      <div class="colab-stat-col" title="Atestados">Atestados:<br><span style="font-size:14px;color:var(--ink);">${stats.atestado}</span></div>
                      <div class="colab-stat-col" title="Acidentes">Acidentes:<br><span style="font-size:14px;color:var(--ink);">${stats.acidente}</span></div>
